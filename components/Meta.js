  ...
  <Head>
    ...
    <style jsx global>{`
      body {
        ...
        margin: 0;
        line-height: 1.6;
        font-family: 'Untitled Sans', system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue,
...
console.log(
  "🐞 Thanks for stopping by. If you've spotted any bugs, want to suggest a new feature, or refactor some code, create an Issue or Pull Request in this site's GitHub repository: https://github.com/0str1ch/js-app"
)
